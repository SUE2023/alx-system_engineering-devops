...
ips: to test your answer Bash script, feel free to reproduce the checker environment:
...
•	Child process concept page:   just before the questions
•	Root and sub domain: https://landingi.com/help/domains-vs-subdomains/  
•	HTTP requests: https://www.tutorialspoint.com/http/http_methods.htm 
•	HTTP redirection: https://moz.com/learn/seo/redirection 
•	Not found HTTP response code: https://en.wikipedia.org/wiki/HTTP_404 and Digital Ocean
